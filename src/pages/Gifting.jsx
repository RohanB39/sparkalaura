  ...
  return (
    ...
    <div className="sticky top-0 z-50 bg-white shadow-md">
      ...
      <div className="container mx-auto p-2 grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-3 gap-3 cursor-pointer">
        {products.filter((product) => product.category === "JarCandles").length === 0 ? (
          <div className="col-span-2 lg:col-span-3 text-center text-gray-600 text-lg font-semibold p-3">
            Oops! No Jar Candles available right now. Check back later for amazing deals! 🛍️
          </div>
        ) : (
          products
            .filter((product) => product.category === "JarCandles")
            .map((product) => (
              <div
                key={product.id}
              ...
              >
                ...
                <div className="p-4">
                  ...
                  <div className="flex">
                    <button className="bg-pink-100 text-[10px] mt-1 text-black cursor-pointer transition-colors duration-300 py-1 px-10 shadow">
                      Add to Cart
                    </button>
                  </div>
                </div>
