...
const CorporatePlantRental = () => {
  ...
  return (
    ...
    <div className="sticky top-0 z-50 bg-white shadow-md">
      ...
      <div className="heroBg4 relative h-[30vh] lg:h-[50vh]">
        <div className="h-[70%] flex flex-col items-center justify-center text-center px-4 relative z-10">
          <p className="text-black text-3xl md:text-5xl">Ceramics Candles</p>
      ...
      <div className="container mx-auto p-2 grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-3 gap-3 cursor-pointer">
        {products.filter((product) => product.category === "CeramicCandles").length === 0 ? (
          <div className="col-span-2 lg:col-span-3 text-center text-gray-600 text-lg font-semibold p-3">
            Oops! No Ceramic Candles available right now. Check back later for amazing deals! 🛍️
          </div>
        ) : (
          products
            .filter((product) => product.category === "CeramicCandles")
            .map((product) => (
              <div
                key={product.id}
              ...
              >
                ...
                <div className="p-4">
                  ...
                  <div className="flex">
                    <button className="bg-orange-200 text-[10px] mt-1 text-black cursor-pointer transition-colors duration-300 py-1 px-10 shadow">
                      Add to Cart
                    </button>
                  </div>
                </div>
...
export default CorporatePlantRental