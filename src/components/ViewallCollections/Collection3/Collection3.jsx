            ...
            <section className="w-full flex flex-col md:flex-row md:items-center justify-center gap-y-4 p-5">
                <div className="flex flex-col items-center w-full">
                    <h2 className="text-[14px] lg:text-2xl">
                        Indulge in soothing aromas—let Lavender Bliss, Vanilla Dream, and Rose Serenity fill your space.
                        <span className="text-red-400">Explore our scented, jar, and ceramic candle collection for a touch of elegance.</span>
                    </h2>
