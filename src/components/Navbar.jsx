  ...
  ${isDropdownOpen ? "pointer-events-auto" : "pointer-events-none opacity-0"}`}
        ...
        <div className="flex items-center gap-2">
          ...
          <div
            className="md:hidden cursor-pointer"
          >
            <NavLink to="/cart" className="text-black relative flex right-2">
            <span>
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-5">
            ...
            {cartCount > 0 && (
                <span className="absolute -top-3 right-3 bg-pink-700 text-white text-[8px] rounded-full w-4 h-4 flex items-center justify-center">
                    {cartCount}
                </span>
            )}
        </NavLink>
